// frontend/components/assistant/inline/InlineCancellationItemPickerV3.tsx
//
// V3-only. CANCELLATION's item + quantity selection stage (V3's
// CancellationItemPicker a2ui type). Adapted from InlineCancellationItemPicker
// (V2) — same UI, but the resume payload carries no "capability" field.
"use client";
...
export function InlineCancellationItemPickerV3({
  eligibleOrders,
  orderNumber,
  isAgentLoading,
  onResumeV3,
